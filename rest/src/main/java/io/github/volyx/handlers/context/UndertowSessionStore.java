package io.github.volyx.handlers.context;
...
public class UndertowSessionStore implements SessionStore<UndertowWebContext> {
    ...
    @Override
    public boolean destroySession(UndertowWebContext context) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Object getTrackableSession(UndertowWebContext context) {
        throw new UnsupportedOperationException();
    }

    @Override
    public SessionStore<UndertowWebContext> buildFromTrackableSession(UndertowWebContext context, Object trackableSession) {
        throw new UnsupportedOperationException();
    }

    @Override
    public boolean renewSession(UndertowWebContext context) {
        throw new UnsupportedOperationException();
    }
